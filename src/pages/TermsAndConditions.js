    ...
    return (
        <div className="max-w-screen-lg mx-auto px-24 py-8">
            ...
            <p className="my-4">
                ...
                regulations for the use of Givers Limited&apos;s
                Website, located at www.givers.com.
            </p>

            <p className="my-4">
                By accessing this website we assume you accept these
                terms and conditions. Do not continue to use Givers if
            ...
            <p className="my-4">
                We employ the use of cookies. By accessing Givers, you
                agreed to use cookies in agreement with the Givers
            ...
            <p className="my-4">
                Unless otherwise stated, Givers Limited and/or its
                licensors own the intellectual property rights for all
                material on Givers. All intellectual property rights
                are reserved. You may access this from Givers for your
            ...
            <ul className="my-4">
                ...
                <li>
                    Sell, rent or sub-license material from Givers
                </li>
                <li>
                    Reproduce, duplicate or copy material from Givers
                </li>
            ...
            <p className="my-4">
                ...
                certain areas of the website. Givers Limited does not
                filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect
                the views and opinions of Givers Limited,its agents
                ...
                Givers Limited shall not be liable for the Comments or
                for any liability, damages or expenses caused and/or
                suffered as a result of any use of and/or posting of
                and/or appearance of the Comments on this website.
            </p>

            <p className="my-4">
                Givers Limited reserves the right to monitor all
            ...
            <p className="my-4">
                You hereby grant Givers Limited a non-exclusive
                license to use, reproduce, edit and authorize others
                to use, reproduce and edit any of your Comments in any
            ...
            <p className="my-4">
                ...
                absence of Givers Limited; and (d) the link is in the
            ...
            <p className="my-4">
                ...
                Givers Limited. Please include your name, your
            ...
            <p className="my-4">
                No use of Givers Limited&apos;s logo or other artwork
