...
const TermsAndConditions = () => {
    return (
        <div className="max-w-screen-lg mx-auto px-24 py-8">
            <h2 className="text-3xl">
                <strong>Terms and Conditions</strong>
            </h2>

            <p className="my-4">Welcome to Givers!</p>

            <p className="my-4">
                These terms and conditions outline the rules and regulations for
                the use of Givers Limited's Website, located at www.givers.com.
            </p>

            <p className="my-4">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Givers if you do not agree to
            ...
            <p className="my-4">
                We employ the use of cookies. By accessing Givers, you agreed to
                use cookies in agreement with the Givers Limited's Privacy
                Policy.{' '}
            </p>
            ...
            <p className="my-4">
                Unless otherwise stated, Givers Limited and/or its licensors own
                the intellectual property rights for all material on Givers. All
                intellectual property rights are reserved. You may access this
                from Givers for your own personal use subjected to restrictions
                set in these terms and conditions.
            </p>

            <p className="my-4">You must not:</p>
            <ul className="my-4">
                <li>Republish material from Givers</li>
                <li>Sell, rent or sub-license material from Givers</li>
                <li>Reproduce, duplicate or copy material from Givers</li>
                <li>Redistribute content from Givers</li>
            </ul>
            ...
            <p className="my-4">
                ...
                website. Givers Limited does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Givers Limited,its agents
                and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent
                permitted by applicable laws, Givers Limited shall not be liable
            ...
            <p className="my-4">
                Givers Limited reserves the right to monitor all Comments and to
            ...
            <p className="my-4">
                You hereby grant Givers Limited a non-exclusive license to use,
            ...
            <p className="my-4">
                ...
                of Givers Limited; and (d) the link is in the context of general
            ...
            <p className="my-4">
                ...
                by sending an e-mail to Givers Limited. Please include your
            ...
            <p className="my-4">
                No use of Givers Limited's logo or other artwork will be allowed
