        ...
        <div className="bg-white w-screen py-24">
            <div className="flex flex-col space-y-12 justify-center items-center">
                ...
                <div className="max-w-screen-lg grid grid-flow-row grid-cols-1 md:grid-cols-3 grid-rows-6 md:grid-rows-2 gap-6 w-full text-center p-8 md:p-8 lg:p-0">
                    <div className="bg-green-50 p-10 md:px-4 md:py-10 flex flex-col justify-center max-w-sm md:w-full mx-auto break-all">
                        <div className="flex flex-row justify-center mb-6"></div>
                        <h1 className="text-xl font-medium mb-2"></h1>
                        <p></p>
                    </div>
                    <div className="bg-green-50 p-10 md:px-4 md:py-10 flex flex-col justify-center max-w-sm md:w-full mx-auto break-all">
                        <div className="flex flex-row justify-center mb-6"></div>
